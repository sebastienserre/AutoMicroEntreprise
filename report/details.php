 ...
 *
 *
 *	\file		automicroent/report/details.php
 *	\ingroup	AutoMicroEntreprise
 *	\brief		Estimated loads details page
...
require_once dirname(__DIR__).'/class/details.class.php';
...
catch( AMEWrongQuarter $e ) {
	AMEError( 'AMEWrongQuarter', $e->getMessage() );
}
catch( DBQueryNoResult $e ) {
	AMEError( 'DBQueryNoResult', $e->getMessage() );
}
