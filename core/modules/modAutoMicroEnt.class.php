...
/**
 *	\defgroup	AutoMicroEntreprise
 * 	\brief		Module descriptor.
 *
 *	\file		automicroent/core/modules/modAutoMicroEnt.class.php
 *	\ingroup	AutoMicroEntreprise
 *	\brief		Description and activation file for module AutoMicroEntreprise
 */
 ...
 */
class modAutoMicroEnt extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'automicroent';
		...
		$this->description = "Description of module AutoMicroEnt";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Description of module AutoMicroEnt (Long)";

		$this->editor_name = 'depordi.fr';
		$this->editor_url = 'https://www.depordi.fr';
		...
		$this->config_page_url = array("index.php@automicroent");

		// Dependencies
		$this->hidden = false;			// A condition to hide module
		$this->depends = array("modComptabilite");		// List of module class names as string that must be enabled if this module is enabled
		$this->requiredby = array();	// List of module ids to disable if this one is disabled
		$this->conflictwith = array();	// List of module class names as string this module is in conflict with
		$this->langfiles = array("automicroent@automicroent");
        ...
        */
		...
		$r=0;
		$this->rights[$r][0] = 451051;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'Use Auto Micro Entreprise Module';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		$this->rights[$r][4] = 'use';				// In php code, permission will be checked by test if ($user->rights->mymodule->level1->level2)
		...
		$this->menu[$r++]=array('fk_menu'	=> 'fk_mainmenu=accountancy',				// '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'		=> 'left',			                	// This is a Top menu entry
								'titre'		=> $langs->trans('AME_MenuLink0'),
								'mainmenu'	=> 'accountancy',
								'leftmenu'	=> 'automicroent',
								'url'		=> '/automicroent/admin/index.php',
								'langs'		=> '',									// Lang file to use (without .lang) by module.
																					// File must be in langs/code_CODE/ directory.
								'position'	=> 1000+$r,
								'enabled'	=> 1,									// Define condition to show or hide menu entry.
																					// Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
								'perms'		=> '$user->rights->automicroent->use',	// Use 'perms'=>'$user->rights->mymodule->level1->level2'
																					// if you want your menu with a permission rules
								'target'	=> '',
								'user'		=> 0);				                	// 0=Menu for internal users, 1=external users, 2=both

		$this->menu[$r++]=array('fk_menu'	=> 'fk_mainmenu=accountancy,fk_leftmenu=automicroent',
								'type'		=> 'left',
								'titre'		=> $langs->trans('AME_MenuLink1'),
								'mainmenu'	=> '',
								'leftmenu'	=> '',
								'url'		=> '/automicroent/report/index.php',
								'langs'		=> '',
								'position'	=> 1000+$r,
								'enabled'	=> 1,
								'perms'		=> '$user->rights->automicroent->use',
								'target'	=> '',
								'user'		=> 0);
	...
	{
		$this->_load_tables('/automicroent/sql/');
